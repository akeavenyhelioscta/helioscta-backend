...
export default function ClearStreetTrades() {
  ...
  useEffect(() => {
    ...
    const url = selectedDate
      ? `/api/clear-street-trades?sftp_date=${selectedDate}`
    ...
    fetch(url, { signal: controller.signal })
      ...
      .catch((err) => {
        ...
        setError(err.message || "Failed to load Clear Street trades data");
      })
        ...
        <div className="rounded-xl border border-gray-800 bg-[#0f1117] px-4 py-3">
          ...
          <div className="flex items-end gap-3">
            <div className="flex flex-col gap-1">
              <label htmlFor="sftp-date-filter" className="text-[10px] font-medium text-gray-500 uppercase tracking-wider">
                SFTP Date
              </label>
              <select
                id="sftp-date-filter"

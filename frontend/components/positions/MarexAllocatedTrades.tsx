...
const COLUMNS: Column[] = [
  ...
  { key: "qty_andy", label: "Qty Andy", align: "right", format: fmtInt, filterable: true },
  { key: "qty_mac", label: "Qty MAC", align: "right", format: fmtInt, filterable: true },
...
export default function MarexAllocatedTrades() {
  ...
  useEffect(() => {
    ...
    const url = selectedDate
      ? `/api/marex-allocated-trades?sftp_date=${selectedDate}`
      : "/api/marex-allocated-trades";
    ...
    fetch(url, { signal: controller.signal })
      ...
      .catch((err) => {
        ...
        setError(err.message || "Failed to load Marex allocated trades data");
      })
        ...
        <div className="rounded-xl border border-gray-800 bg-[#0f1117] px-4 py-3">
          ...
          <div className="flex items-end gap-3">
            <div className="flex flex-col gap-1">
              <label htmlFor="marex-sftp-date-filter" className="text-[10px] font-medium text-gray-500 uppercase tracking-wider">
                SFTP Date
              </label>
              <select
                id="marex-sftp-date-filter"
                value={pendingDate}

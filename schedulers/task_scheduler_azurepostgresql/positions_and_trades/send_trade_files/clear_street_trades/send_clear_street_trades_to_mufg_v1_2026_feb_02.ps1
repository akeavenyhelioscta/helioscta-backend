...
$PythonScript1 = "C:\Users\AidanKeaveny\Documents\github\helioscta-backend\backend\src\postions_and_trades\tasks\email_sftp_files\send_clear_street_trades_to_mufg_v1_2026_feb_02.py"
...
Register-ScheduledTask `
    -TaskName "Send Clear Street Trades to MUFG" `
    -Action $action `
    -Trigger $triggers `

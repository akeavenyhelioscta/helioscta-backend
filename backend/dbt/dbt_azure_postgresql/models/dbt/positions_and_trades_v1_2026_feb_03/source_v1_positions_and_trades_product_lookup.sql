...
SELECT * FROM (
    ...
    ('NG', 'HH',  NULL,  'GAS_FUTURES', 'HENRY_HUB',                'GLOBEX NATURAL GAS LD', 'NAT GAS LAST DAY FINAN'),
    ('NG', 'HH',  NULL,  'GAS_FUTURES', 'HENRY_HUB',                'NYMEX HENRY HUB FINANCIAL LDO', 'NAT GAS LAST DAY FINAN'),

...
def _format(
    ...
    # dtypes
    str_columns = ['market', 'location', 'location_type', 'pnode']
...
def _upsert(
    ...
    primary_key_candidates = ['interval_start_local', 'interval_start_utc', 'interval_end_local', 'interval_end_utc', 'market', 'location', 'location_type', 'pnode']
...
def main(
        dates: list = [(datetime.now() - timedelta(days=14), datetime.now() + timedelta(days=1))],
    ):

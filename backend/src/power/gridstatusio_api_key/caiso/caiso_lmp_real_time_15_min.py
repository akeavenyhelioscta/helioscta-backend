...
def _format(
    ...
    float_columns = ['lmp', 'energy', 'congestion', 'loss', 'ghg']
...
def _upsert(
    ...
    primary_key_candidates = ['interval_start_local', 'interval_start_utc', 'interval_end_local', 'interval_end_utc', 'market', 'location', 'location_type']

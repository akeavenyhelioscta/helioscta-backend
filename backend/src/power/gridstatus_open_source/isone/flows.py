"""
Prefect flow definitions for GridStatus ISONE scripts.
...
@flow(name="isone_fuel_mix", retries=2, retry_delay_seconds=60, log_prints=True)
def isone_fuel_mix():
    return _load_main("isone_fuel_mix")()

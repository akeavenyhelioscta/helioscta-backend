...
def _pull(
        ...
        endpoint: str = "np4-737-cd/spp_hrly_avrg_actl_fcast",
    ) -> pd.DataFrame:
    """
    Solar Power Production - Hourly Averaged Actual and Forecasted Values: https://apiexplorer.ercot.com/api-details#api=pubapi-apim-api&operation=getData_9
    NP4-745-CD
    """

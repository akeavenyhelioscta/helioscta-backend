...
def _pull(
        ...
        endpoint: str = "np3-565-cd/lf_by_model_weather_zone",
    ) -> pd.DataFrame:
    """
    Seven-Day Load Forecast by Model and Weather Zone: https://apiexplorer.ercot.com/api-details#api=pubapi-apim-api&operation=getData_101
    """

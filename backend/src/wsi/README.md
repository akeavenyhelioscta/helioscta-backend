...
- List scripts for a domain: `python backend/src/wsi/<domain>/runs.py --list`
- Run all scripts in a domain: `python backend/src/wsi/<domain>/runs.py all`
- Run one script in a domain by menu index: `python backend/src/wsi/<domain>/runs.py 2`
- Example: `python backend/src/wsi/weighted_degree_day/runs.py --list`

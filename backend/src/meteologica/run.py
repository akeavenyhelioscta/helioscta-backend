...
Usage:
    python run.py                    # interactive menu (all regions)
    ...
    python run.py pjm               # run all PJM scripts
    python run.py ercot miso        # run all ERCOT + MISO scripts
    python run.py l48 --list        # list only L48 scripts
"""
...
EXCLUDE = {"__init__.py", "auth.py", "run.py", "flows.py"}

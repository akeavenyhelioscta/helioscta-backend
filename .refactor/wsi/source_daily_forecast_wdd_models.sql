...
-- ORDER BY forecast_execution_datetime desc, forecast_date asc, model asc, cycle asc, bias_corrected asc, region asc
...
--     AND cycle = '00Z'
--     AND region = 'CONUS'
--     AND forecast_execution_date = current_date
-- ORDER BY region ASC, model ASC, forecast_execution_datetime DESC, forecast_date ASC, bias_corrected
...
-- WHERE 
--     region = 'CONUS'
--     AND rank_forecast_execution_timestamps in (1)
